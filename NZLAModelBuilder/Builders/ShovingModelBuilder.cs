...
{
    internal class ShovingModelBuilder : ClassificationModelBuilderBase
    {

        public ShovingModelBuilder(string workFolder, List<RoadSegmentBase> segments, Double testDataFraction = 0.25)
        {            
            this.WorkFolder = workFolder;
            
            this.SetupFilePaths("shoving");
            ...
            foreach (var segment in segments)
            {
                ...
                if (segment.PctShoving > 0) { segment.Target_Classification = true; }
            }
