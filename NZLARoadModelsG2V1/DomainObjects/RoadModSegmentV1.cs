...
public class RoadModSegmentV1: JCass_ModelCore.Customiser.ModelElementBase
{
    ...
    private void SetPDI()
    {
        ...
        {
            this._pdi = JCass_Core.Engineering.IndexCalculator.GetCOST354Index(defects, this.SetupInfo.WeightsPDI, 4, 20);
        }
        else
        {
    ...
    private void SetSDI()
    {
        ...
        {
            this._sdi = JCass_Core.Engineering.IndexCalculator.GetCOST354Index(defects, this.SetupInfo.WeightSDI, 4, 20);
        }
        else
        {
    ...
    private void SetObjective()
    {
        ...
        this._objective = JCass_Core.Engineering.IndexCalculator.GetCOST354Index(defects, tmp_weights2, 4, 20);
